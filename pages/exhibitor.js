          ...
          <div id="detail-exhibitor store-detail">
            <div className="store-name">
              <div className="container">
                <a href="#" className="connect-exhibitor"><img src="/images/user2.png" alt="" />{translate(langConfig.app.Exhibitor)}</a>
                <h3>
                ...
                <div id="navigation">
                  <div className="container">
                    <div className={"collapse navbar-collapse" + (toggle ? " show" : "")} id="navbarResponsive">
                      ...
                      <a href={"/user?filter=" + MODE.exhibitor} className="right"><img src="/images/icon-list.png" alt="" />{translate(langConfig.app.List)}</a>
                    </div>
                  </div>
                </div>
              </div>
