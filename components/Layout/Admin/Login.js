...
class Login extends Component {
    ...
    handleSubmit = e => {
        ...
        dispatch({
            ...
            callback: data => {
                if (!data?.success) {
                    this.setState({ message: translate(data?.messages || langConfig.app.LoginFailed) })
                }
            }
        })
    }
            ...
            <div className="login-page">
                <div className="login-box">
                    ...
                    <div className="box login-box-body">
                        ...
                        <Link href="/">
                            <a className="btn btn-link">{translate(langConfig.app.ForgetPassword)}?</a>
                        </Link>
                        <Link href="/">
                            <a className="btn btn-link">{translate(langConfig.app.Register)}</a>
                        </Link>
                    </div>
                </div>
            </div>
