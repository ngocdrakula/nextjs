                        ...
                        <form method="POST" action="/" id="vis-edit-form" onSubmit={this.handleSubmit} >
                            ...
                            <div className="modal-body">
                                ...
                                <div className={"form-group" + (fieldError === 'embed' ? " has-error" : "")}>
                                    ...
                                    <textarea className="form-control summernote" required rows={3} placeholder={translate(langConcat(langConfig.app.Enter, langConfig.app.EmbedCode))} value={description} value={embed} name="embed" cols={50} id="update-live-embed" onChange={this.handleChange} />
                                    <div className="help-block with-errors">
