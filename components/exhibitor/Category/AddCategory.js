                    ...
                    if (res?.success) {
                        dispatch({
                            ...
                            payload: {
                                ...
                                message: 'Bạn muốn thêm chuyên mục khác?',
                                confirm: 'Thêm',
                                cancel: 'Đóng',
                                ...
                                <div className="row">
                                    <div className="col-md-8 nopadding-right">
                                        <div className={"form-group" + (fieldError === 'name' ? " has-error" : "")}>
                                            <label htmlFor="add-vis-name">Tên chuyên mục*</label>
                                            <input className="form-control" placeholder="Nhập tên chuyên mục" required value={name} id="add-vis-name" name="name" type="text" onChange={this.handleChange} />
